...
<script type="text/javascript">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" >
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <br>
        <li class="nav-item">
          <a href='/admin/listpeserta' class="nav-link">
        ...
        <br>
        <li class="nav-item">
            <a href='/admin/berkas' class="nav-link">
                <i class="nav-icon fa fa-file-archive"></i>
              <p>
                LIHAT PENGAJUAN SERTIFIKASI
              </p>
            </a>
        </li>
        <br>
        <li class="nav-item">
            ...
            <a href='/daftartanggalujian' class="nav-link">
                <i class="nav-icon fa-solid fa-user-check"></i>
              <p>
                DETAIL PESERTA UJIAN SERTIFIKASI
              </p>
            </a>
        </li>
        <li class="nav-item">

            <a href='/detailujianpeserta' class="nav-link">
        ...
        <li class="nav-item">
            ...
            <a href='/detailjawaban' class="nav-link">
  ...
  width: 100%;
  ">
    <strong>Copyright &copy; 2024 <a >SMK Muhamadiyah 1 Moyudan </a>.</strong>
    All rights reserved.
